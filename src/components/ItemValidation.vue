    ...
    data() {
        return {
            ...
            questions: [
                ...
                { id: 'q8', text: 'I feel <strong>confident</strong> about this visualization.' },
                { id: 'q9', text: 'I find this visualization <strong>difficult to read</strong>.' },
                { id: 'q10', text: 'I feel <strong>confused</strong> by the visualization.' },
                { id: 'q11', text: 'I feel <strong>overwhelmed</strong> by the visualization.' },
                { id: 'q12', text: 'I feel <strong>curious</strong> about this visualization.' },
                { id: 'q13', text: 'I feel <strong>irritated</strong> by this visualization.' },
                { id: 'q14', text: 'I find there is <strong>a lot of information</strong> in this visualization.' },
                { id: 'q15', text: 'I find this visualization <strong>easy to use</strong>.' },
                { id: 'q16', text: 'I find this visualization <strong>intuitive</strong>.' },
                { id: 'q17', text: 'I find this visualization <strong>visually pleasing</strong>.' },
                { id: 'q18', text: 'I feel that this visualization causes <strong>cognitive overload</strong>.' },
                { id: 'q19', text: 'I feel the <strong>mental demand</strong> of this visualization is high/low.' },
                { id: 'q20', text: 'I find the <strong>color coding</strong> overly complex.' },
                { id: 'q21', text: 'I find the <strong>visual encoding</strong> is poor and violates good practice.' },
                { id: 'q22', text: 'I find this visualization <strong>attractive</strong>.' },
                { id: 'q23', text: 'I find the visualization has <strong>unnecessary complexity</strong>.' },
                ...
                { id: 'q40', text: 'I can <strong>detect patterns</strong> in the visualization.' },
                { id: 'q41', text: 'I find the visualization is <strong>missing important details</strong>.' },
                { id: 'q42', text: 'I find the visualization requires <strong>effort</strong> to understand.' },
                { id: 'q43', text: 'I find the visualization has <strong>poor pattern visibility</strong>.' },
                { id: 'q44', text: 'I find <strong>all data points are visible</strong> in the visualization.' },
                { id: 'q45', text: 'I find the variables in the visualization <strong>visible</strong>.' },
                { id: 'q46', text: 'I find the visualization is <strong>poorly designed</strong>.' },
                { id: 'q47', text: 'I can find this <strong>survey</strong> in Prolific.' },
                { id: 'q48', text: 'I find the visualization has a <strong>complex visual appearance</strong>.' },
                { id: 'q49', text: 'I find additional graphics would help in <strong>communication</strong>.' }
            ],
        };
    },
    computed: {
